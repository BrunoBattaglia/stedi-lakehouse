...
AWSGlueDataCatalog_node1775303267134 = glueContext.create_dynamic_frame.from_catalog(database="stedi", table_name="accelerometer_trusted", transformation_ctx="AWSGlueDataCatalog_node1775303267134")
...
ON c.email = a.user
'''
SQLQuery_node1775303299383 = sparkSqlQuery(glueContext, query = SqlQuery3113, mapping = {"c":AWSGlueDataCatalog_node1775159469964, "a":AWSGlueDataCatalog_node1775303267134}, transformation_ctx = "SQLQuery_node1775303299383")

# Script generated for node Drop Duplicates
DropDuplicates_node1775159516339 =  DynamicFrame.fromDF(SQLQuery_node1775303299383.toDF().dropDuplicates(["email"]), glueContext, "DropDuplicates_node1775159516339")
